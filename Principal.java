...
public class Principal extends JFrame implements ActionListener{
   ...
   public Principal(){
     ...
     miRojo.setFont(new Font("Andele Mono", 1,14));
     miRojo.setForeground(new Color(255,0,0));
     menuColorFondo.add(miRojo);
     miRojo.addActionListener(this);

     miNegro = new JMenuItem("Negro");
     miNegro.setFont(new Font("Andele Mono", 1,14));
     miNegro.setForeground(new Color(255,0,0));
     menuColorFondo.add(miNegro);
     miNegro.addActionListener(this);
    
     miMorado = new JMenuItem("Morado");
     miMorado.setFont(new Font("Andele Mono", 1,14));
     miMorado.setForeground(new Color(255,0,0));
     menuColorFondo.add(miMorado);
     miMorado.addActionListener(this);

     miNuevo = new JMenuItem("Nuevo");
     miNuevo.setFont(new Font("Andele Mono", 1,14));
     miNuevo.setForeground(new Color(255,0,0));
     menuOpciones.add(miNuevo);
     miNuevo.addActionListener(this);
  
     miElCreador = new JMenuItem("El Creador");
     miElCreador.setFont(new Font("Andele Mono", 1,14));
     miElCreador.setForeground(new Color(255,0,0));
     menuAcercaDe.add(miElCreador);
     miElCreador.addActionListener(this);
 
     miSalir = new JMenuItem("Salir");
     miSalir.setFont(new Font("Andele Mono", 1,14));
     ...
     txtNombreTrabajador.setFont(new java.awt.Font("Andele Mono", 1, 14));
     ...
     txtAPaternoTrabajador.setFont(new java.awt.Font("Andele Mono", 1, 14));
     ...
     txtAMaternoTrabajador.setFont(new java.awt.Font("Andele Mono", 1, 14));
     ...
     comboAntiguedad.addItem("7 a�os o mas de servicio");
     ...
     textarea1.setFont(new Font("Andele Mono", 1, 11));
     ...
     labelfooter.setFont(new java.awt.Font("Andele Mono", 1, 12));
    ...
    if (e.getSource() == miCalculo){
        ...
        if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") || 
           ...
           if(Departamento.equals("Atencion al cliente")){
                                ...
                                if(Antiguedad.equals("7 a�os o mas de servicio")){
                                         textarea1.setText("\n El trabajador " + nombreTrabajador + " " + AP + " " + AM +
                                                           "\n quien labora en " + Departamento + " con " + Antiguedad + 
     ...
     if (e.getSource() == miRojo){ 
      ...
      if (e.getSource() == miSalir){
          ...
          Bienvenida ventanadebienvenida = new Bienvenida();
          ventanadebienvenida.setBounds(0,0,350,450);
          ventanadebienvenida.setVisible(true);
          ventanadebienvenida.setResizable(false);
          ventanadebienvenida.setLocationRelativeTo(null);
          this.setVisible(false);
    } 
      if (e.getSource() == miElCreador){
           JOptionPane.showMessageDialog(null, "Desarrollado por Hector Enriquez\n"+
                                         "                     deveckor.com");
    } 
  }
